...
def game():
    ...
    print(
        'Тебе загадана последовательность из 4 цифр. Ты пытаешься отгадать эти цифры. '
        'Если ты угадал цифру и она на своем месте, то это бык. Но если ты угадал цифру, '
        'но не её место, то это корова. Ну что ж, сыграемс?')

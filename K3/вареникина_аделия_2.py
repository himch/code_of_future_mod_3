...
# Игрок должен ходить по комнатам побеждать монстров и искать улики. Игра завершается, когда все улики найдены и монстры побеждены. Если же игрок умирает раньше,чем выполнит задания- он проиграл.
#Игроку представлены правишла, в которых описываются возможности игры: возможные действия, их плюсы и минусы,также как победить и проиграть. Также описываются начальные HP и Hit
...
play = True
while play == True:# Создаём цикл для игры, чтобы можно было играть больше одного раза
